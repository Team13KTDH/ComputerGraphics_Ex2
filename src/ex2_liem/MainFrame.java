...
public class MainFrame extends JFrame implements ActionListener {
	...
	public void initUI() {
		...
		tf1.setBounds(70, 50, 100, 40);
		tf1.setFocusable(true);
		tf1.setText("");
		tf1.setEditable(true);

		tf2.setBounds(70, 110, 100, 40);
		tf2.setFocusable(true);
		tf2.setText("");
		tf2.setEditable(true);

		tf3.setBounds(70, 170, 100, 40);
		tf3.setFocusable(true);
		tf3.setText("");
		tf3.setEditable(true);

		tf4.setBounds(70, 230, 100, 40);
		...
		label3.setFont(new Font("Ink Free", Font.CENTER_BASELINE, 18));
		// nut thu nhat
		bt0.setText("Net Dut");
		bt0.setBounds(70, 340, 150, 40);
		...
		label6.setBounds(10, 640, 600, 40);
		label6.setEnabled(false);
		label6.setText("NOTE!!!:Don't set value x1 = x2 or y1 == y2 with RETANGLE ");
